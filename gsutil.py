...
if ver.major != 3 or ver.minor < 10 or ver.minor > 14:
  sys.exit(
    "Error: gsutil requires Python version 3.10-3.14, but a different version is installed.\n"
    "You are currently running Python {}.{}\n"
    "Follow the steps below to resolve this issue:\n"
    "\t1. Switch to Python 3.10-3.14 using your Python version manager or install an appropriate version.\n"
