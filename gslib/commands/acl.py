...
<B>SET</B>
  ...
  refer to objects or the recursive flag is on. Performing acl set on multiple 
  buckets in one go eg. gsutil -m acl set gs://bucket1 gs://bucket2 will run 
  the acl set operations sequentially.
