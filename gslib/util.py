...
cached_multiproessing_is_available_stack_trace = None
...
def MultiprocessingIsAvailable():
  """
  ...
  cached_multiproessing_check_stack_trace = stack_trace
