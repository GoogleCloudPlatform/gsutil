...
class GcsJsonApi(CloudApi):
  ...
  def _FieldsContainsAclField(self, fields=None):
    ...
    Args:
      fields: list or set of fields. May be in GET ['acl'] or List ['items/acl']
        call format.
  ...
  def _DecryptHashesIfPossible(self, bucket_name, object_metadata, fields=None):
    ...
    Args:
      ...
      object_metadata: apitools Object describing the object. Must include name,
        generation, and customerEncryption fields.
  ...
  def _UploadObject(self,
    ...
    Cloud API arguments, plus two more.
