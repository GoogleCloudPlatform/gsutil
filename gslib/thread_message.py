...
class RetryableErrorMessage(StatusMessage):
    ...
    def __init__(
        ...
        if isinstance(exception, apitools_service_error) or isinstance(
            exception, six_service_error
        ):
    ...
    def __str__(self):
        """Returns a string with a valid constructor for this message."""
        return (
            "%s(%s(), num_retries=%s, total_wait_sec=%s, "
...
class FileMessage(StatusMessage):
    ...
    def __str__(self):
        """Returns a string with a valid constructor for this message."""
        return (
            "%s('%s', '%s', %s, size=%s, finished=%s, component_num=%s, "
...
class ProgressMessage(StatusMessage):
    ...
    def __str__(self):
        ...
        return (
            "%s(%s, %s, '%s', %s, dst_url=%s, component_num=%s, "
