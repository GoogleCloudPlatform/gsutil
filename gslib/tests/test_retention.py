...
class TestRetention(testcase.GsUtilIntegrationTestCase):
    ...
    def test_set_retention_multiple_parallel(self):
        ...
        self.RunGsUtil(
            ["-m", "retention", "set", "1y", suri(bucket1_uri), suri(bucket2_uri)]
        )
    ...
    def test_decrease_retention_unlocked(self):
        ...
        self.RunGsUtil(
            ["retention", "set", "{}s".format(_SECONDS_IN_DAY), suri(bucket_uri)]
        )
        self.VerifyRetentionPolicy(
            bucket_uri, expected_retention_period_in_seconds=_SECONDS_IN_DAY
        )
    ...
    def test_lock_with_no_retention_policy_invalid(self):
        ...
        self.assertRegexpMatches(stderr, "does not have an Unlocked Retention Policy")
        self.VerifyRetentionPolicy(
            bucket_uri, expected_retention_period_in_seconds=None
        )
    ...
    def test_lock_retention_already_locked(self):
        ...
        self.assertRegexpMatches(stderr, r"Retention Policy on .* is already locked")
    ...
    def test_increase_retention_locked(self):
        ...
        self.RunGsUtil(
            ["retention", "set", "{}s".format(_SECONDS_IN_DAY + 1), suri(bucket_uri)]
        )
        self.VerifyRetentionPolicy(
            bucket_uri,
    ...
    def test_set_temporary_hold_invalid_arg(self):
        ...
        stderr = self.RunGsUtil(
            ["retention", "temp", "held", suri(object_uri)],
            expected_status=1,
            return_stderr=True,
        )
        self.assertRegexpMatches(
    ...
    def test_temporary_hold_multiple_sequential(self):
        ...
        self.RunGsUtil(
            ["retention", "temp", "set", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
        ...
        self.RunGsUtil(
            ["retention", "temp", "release", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
    ...
    def test_temporary_hold_multiple_parallel(self):
        ...
        object2_uri = self.CreateObject(bucket_uri=bucket_uri, contents="content")
        self.RunGsUtil(
            ["-m", "retention", "temp", "set", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
            bucket_uri, object1_uri, temporary_hold=True
        )
        ...
        self.RunGsUtil(
            ["-m", "retention", "temp", "release", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
            bucket_uri, object1_uri, temporary_hold=False
        )
    ...
    def test_set_event_based_hold_invalid_arg(self):
        object_uri = self.CreateObject()
        stderr = self.RunGsUtil(
            ["retention", "event", "rel", suri(object_uri)],
            expected_status=1,
            return_stderr=True,
        )
        self.assertRegexpMatches(
    ...
    def test_event_based_hold_multiple_sequential(self):
        ...
        object2_uri = self.CreateObject(bucket_uri=bucket_uri, contents="content")
        self.RunGsUtil(
            ["retention", "event", "set", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
        ...
        self.RunGsUtil(
            ["retention", "event", "release", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
    ...
    def test_event_based_hold_multiple_parallel(self):
        ...
        object2_uri = self.CreateObject(bucket_uri=bucket_uri, contents="content")
        self.RunGsUtil(
            ["-m", "retention", "event", "set", suri(object1_uri), suri(object2_uri)]
        )
        self._VerifyObjectHoldAndRetentionStatus(
            bucket_uri, object1_uri, event_based_hold=True
        )
    ...
    def test_default_event_based_hold_multiple_sequential(self):
        ...
        bucket2_uri = self.CreateBucket()
        self.RunGsUtil(
            ["retention", "event-default", "set", suri(bucket1_uri), suri(bucket2_uri)]
        )
        self._VerifyDefaultEventBasedHold(
    ...
    def _VerifyObjectHoldAndRetentionStatus(
        self,
        bucket_uri,
        object_uri,
        temporary_hold=None,
        ...
        if retention_period is None:
            ...
            if event_based_hold is None:
                self.assertEqual(
                    object_metadata.retentionExpirationTime, expected_expiration_time
                )
            else:
    ...
    def _VerifyDefaultEventBasedHold(
        self, bucket_uri, expected_default_event_based_hold=None
    ):
        actual_default_event_based_hold = self.json_api.GetBucket(
            bucket_uri.bucket_name, fields=["defaultEventBasedHold"]
